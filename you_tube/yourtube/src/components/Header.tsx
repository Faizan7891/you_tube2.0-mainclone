import { Bell, Menu, Mic, Search, User, VideoIcon, Moon, Sun, Settings, Monitor } from "lucide-react";
...
const Header = () => {
  const { user, logout, handlegooglesignin, updateTheme } = useUser();
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                <DropdownMenuRadioGroup 
                  ...
                  onValueChange={(val) => {
                    if (updateTheme) updateTheme(val);
                  }}
                >
                  <DropdownMenuRadioItem value="auto">
                    <Monitor className="mr-2 h-4 w-4" /> Auto (IST)
                  </DropdownMenuRadioItem>
